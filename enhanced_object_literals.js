...
//*if we wan to add opening hours to restaurant we simply add it like in the given bit
const restaurant = {
  ...
  //! we have new way of defining fucntion also now dont need any property name for it.
